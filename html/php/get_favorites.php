...
if (!$conn) {
   echo "Connection failed: ". mysqli_connect_error(). "\n";
    ...
    // check username
    $user_query = "SELECT itemName, restaurant.name as rname, restaurant.rid as rid FROM favorites, restaurant WHERE username = '". $username."' AND favorites.rid = restaurant.rid";
